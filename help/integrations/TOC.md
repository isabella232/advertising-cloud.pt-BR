...
+ Integração com o Adobe Audience Manager {#audience-manager}
   ...
   + [Importar segmentos do Audience Manager para o Advertising Cloud](/help/integrations/audience-manager/import-audiences.md)
...
+ [Configurar testes A/B para anúncios Advertising Cloud DSP no Adobe Target](/help/integrations/target/overview-ab-tests.md)
