...
| [!UICONTROL Goals] | [!UICONTROL Day parting] | Se a segmentação de dia for *[!UICONTROL ON]* ou *[!UICONTROL OFF]*.<br><b>Observação:</b> para verificar a programação de dayparting real, abra as configurações de posicionamento em  [!DNL DSP]. | — |
...
| [!UICONTROL Goals] | [!UICONTROL Pace on] | Se a disposição está avançando em direção a *[!UICONTROL Budget]* ou *[!UICONTROL Impressions]*. | — |
...
| [!UICONTROL Goals] | [!UICONTROL Frequency Cap] | O limite de frequência principal para a colocação durante o [!UICONTROL Frequency Cap Interval] especificado. | Sim |
...
| [!UICONTROL Goals] | [!UICONTROL Secondary Frequency Cap] | O limite de frequência secundário para a colocação durante o período especificado [!UICONTROL Secondary Frequency Cap Interval] | Sim |
...
| [!UICONTROL Goals] | [!UICONTROL Secondary Frequency Cap Interval Value] | O número de semanas, dias, horas ou minutos para os quais [!UICONTROL Secondary Frequency Cap] se aplica. Por exemplo, se o limite secundário for de três impressões por seis horas, o valor aqui seria <b>6&lt;/guilabel>. | Sim |
| [!UICONTROL Audience Location] | [!UICONTROL Audience Location - Included #] | O número de localizações geográficas direcionadas, *[!UICONTROL All]* ou *[!UICONTROL None]*. | — |
...
| [!UICONTROL Inventory] | [!UICONTROL Public Inventory - Included #] | O número de ofertas de inventário público direcionadas, se houver, *[!UICONTROL All]* ou *[!UICONTROL None]*. | — |
| [!UICONTROL Inventory] | [!UICONTROL Public Inventory - Excluded #] | O número de ofertas de inventário público excluídas, se houver, ou *[!UICONTROL None]*. | — |
| [!UICONTROL Inventory] | [!UICONTROL Private Inventory - Included #] | O número de ofertas de inventário privado direcionadas, se houver, *[!UICONTROL All]* ou *[!UICONTROL None]*. | — |
| [!UICONTROL Inventory] | [!UICONTROL Private Inventory - Excluded #] | O número de ofertas de inventário privado excluídas, se houver, ou *[!UICONTROL None]*. | — |
| [!UICONTROL Inventory] | [!UICONTROL On Demand Inventory - Included #] | O número de ofertas [!UICONTROL On-Demand Inventory] direcionadas, se houver, *[!UICONTROL All]* ou *[!UICONTROL None]*. | — |
...
| [!UICONTROL Sites] | [!UICONTROL Exclude out-stream] | Se a opção Direcionamento de inventário para excluir o tráfego externo é &lt;i[!UICONTROL >ON]* ou *[!UICONTROL OFF]*.<br>Anúncios de fora normalmente aparecem sobre o conteúdo como um pop-up ou empilhados em conteúdo (na experiência nativa), em vez de como anúncios de vídeo comuns em um reprodutor de vídeo. | — |
...
| [!UICONTROL Audience Targeting] | [!UICONTROL Demographic booster] | Se [!DNL Comscore] segmentos demográficos estão ou não habilitados para a disposição (e outras disposições na campanha): *[!UICONTROL ON]* ou *[!UICONTROL OFF]*. Esse recurso pode ser ativado somente para campanhas para as quais o recurso [!DNL Audience Verification] está ativado para [!DNL Nielson] e/ou [!DNL Comscore].  Incorre em taxas adicionais. | — |
...
| [!UICONTROL Audience Targeting] | [!UICONTROL Device Targeting - Included #] | O número de alvos de dispositivo direcionados, se houver, ou *[!UICONTROL All]*. | — |
| [!UICONTROL Audience Targeting] | [!UICONTROL Device Targeting - Excluded #] | O número de alvos de dispositivo excluídos, se houver, ou *[!UICONTROL None]*. | — |
| [!UICONTROL Audience Targeting] | [!UICONTROL ISP Targeting - Included #] | O número de provedores de ISP direcionados, se houver, ou *[!UICONTROL All]/i>. | — |
...
| [!UICONTROL Brand Safety] | [!UICONTROL Brand Safety - Pre-Bid Fraud blocking #] | O número de filtros de bloqueio de fraude pré-lances aplicados, se houver, ou *[!UICONTROL None]*. | — |
| [!UICONTROL Brand Safety] | [!UICONTROL Brand Safety - Pre-Bid Viewability #] | O número de filtros de visualização pré-lances aplicados, se houver, ou *[!UICONTROL None]*. | — |
...
| [!UICONTROL Tracking] | [!UICONTROL 3rd-party fees] | Uma taxa de taxa estática de terceiros a ser rastreada como um custo não faturável por mil impressões, se aplicável. | — |
| [!UICONTROL Ads] | [!UICONTROL # of Ads Attached] | O número de anúncios anexados à disposição, se houver, ou *[!UICONTROL None]*. | — |
| [!UICONTROL Ads] | [!UICONTROL Ad Names] | Os nomes dos anúncios anexados à disposição, se houver, ou *[!UICONTROL None]*. | — |
